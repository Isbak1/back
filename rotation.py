...
img = importationl('bak.jpg')
img1 = importationl('youl.jpg')

# exemple d'une image débruitée par filtre un passe bas
affichage([[img, 'Image originale'], [bruit(img, 9), 'Image bruité'],
            [filtre_bas(img, 2, 2), 'Image filtré']])
